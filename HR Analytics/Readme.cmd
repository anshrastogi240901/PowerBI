...
- Identify **high-performing employees at risk of leaving**
...
|---------------------|---------------|----------------|
| **High Performance** | Retain & Reward | Critical Risk |
| **Low Performance**  | Optimize | Exit/Reskill |
...
- Replacement Cost: 6 months salary
- Cost per Exit: ₹7.5 lakh

**Scenario Analysis:**
- Employee base: 3,000
- Attrition reduction scenario (e.g., 3%)
- Estimated cost savings calculated using:
